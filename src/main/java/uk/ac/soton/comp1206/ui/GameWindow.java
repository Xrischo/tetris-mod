...
public class GameWindow {
    ...
    /**
     * Display the scores in a single player game
     */
    public void startScores(Game game) { loadScene(new ScoresScene(this, game)); }
    
    /**
     * Display the scores in a multiplayer game
     * @param game The multiplayer game
     */
    public void startLeaderboard(MultiplayerGame game) { loadScene(new ScoresScene(this, game)); }
     ...
     */
    public void startGuide() { loadScene(new InstructionScene(this)); }
